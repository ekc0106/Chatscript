...
static char* Output_Function(char* word, char* ptr, char* space, char*& buffer, unsigned int controls, FunctionResult& result, bool once)
{
    ...
    else // functions or ordinary words
    {
        ...
        {
            if (*currentRuleOutputBase && (!strcmp(word, (char*)"^gambit") || !strcmp(word, (char*)"^respond") || !strcmp(word, (char*)"^reuse") || !strcmp(word, (char*)"^retry") || !strcmp(word, (char*)"^refine") || !strcmp(word, (char*)"^print") || !strcmp(word, (char*)"^printbefore") || !strcmp(word, (char*)"^printafter") || !strcmp(word, (char*)"^sequence"))) // leaving current rule
            {
